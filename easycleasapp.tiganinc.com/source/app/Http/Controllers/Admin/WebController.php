...
class WebController extends Controller
{
    ...
    public function adminSettings(Request $request)
    {
        ...
        $adminMsgKey = DB::table('tbl_msg_key')
                        ->where('id', '1')
                        ->first();
    	return view('admin.web.settings', compact("adminWebName","adminWebLogo", "adminAppUpdate" ,"title","adminFcm","adminOtp","adminMsgKey","abouts","term","map","complaint_raise",
    "tbl_rating"));
    }
     ...
     public function adminUpdateOtp(Request $request)
    {
            ...
            public function gmap(Request $request)
        {
            ...
            $coins_id=$request->map_id;
            
            $faq_category=DB::table('gmap_key')
                         ->first();
       
        return view('admin.gmap',compact("faq_category"));
    }
    
    public function gmap_update(Request $request)
        {

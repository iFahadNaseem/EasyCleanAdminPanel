...
class BookingController extends Controller
{
    ...
    public function index()
    {
        ...
        ->first();
        $message = DB::table('tbl_msg_key')
        ->first(); 
        $mail = DB::table('tbl_email')
        ->first(); 

        $coin=DB::table('booking_coins')
                        
        ->first();

        return view('admin.booking_setting.index',compact("faq_category","message","mail","coin"));
    }

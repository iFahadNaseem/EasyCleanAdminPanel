                  ...
                  <div class="profile-body pt-0 pt-sm-4">
                    <ul class="nav tab-switch " role="tablist ">
                      <li class="nav-item ">
                        ...
                        " role="tab " aria-controls="user-profile-info " aria-selected="true ">Add Navbar App</a>
                      </li>
                    </ul>
                    <div class="row ">
                        ...
                        <div class="tab-content tab-body " id="profile-log-switch ">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <form class="forms-sample" action="{{route('adminAddNewNavBarApp')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}

                                <div class="form-group">
                                  <label for="navbar_app_name">navbar app name :</label>
                                  <input type="text" class="form-control" id="navbar_app_name" name="navbar_app_name" placeholder="navbar app name" value="{{old('navbar_app_name')}}">
                                </div>
                                      ...
                                      <div class="col-md-3" style="margin-top: 5px;">
                                        ...
                                        <div class="form-check form-check-flat" style="margin: 4px 20px 2px 20px;">
                                          <label class="form-check-label" style="font-size: 11px;">
                                            <input type="checkbox" name="navbar_app[]" value="{{$apps->id}}" class="form-check-input"> {{$apps->app_name}}
                                          </label>
                                        </div>
                                      </div>
                                    @endforeach

                        ...
                        <div class="tab-content tab-body " id="profile-log-switch ">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <form class="forms-sample" action="{{route('adminUpdateUser', [$user->id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="user_phone" name="user_phone" placeholder="user phone" value="{{$user->user_phone}}">
                                </div>

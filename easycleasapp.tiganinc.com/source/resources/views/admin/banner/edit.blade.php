                ...
                <div class="card-body">
                  <div class="profile-body pt-0 pt-sm-4">
                        ...
                        <div class="tab-content tab-body " id="profile-log-switch ">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <form class="forms-sample" action="{{route('adminUpdateBanner', [$adminEditBanner->id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="child_category_id">
		          	...
		          	<option value="{{$category->child_category_id}}" @if($category->child_category_id == $adminEditBanner->child_category_id) selected @endif>{{$category->child_name}}</option>
		              @endforeach
                    </select>
                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="banner_name" name="banner_name" placeholder="banner name" value="{{$adminEditBanner->banner_name}}">
                                </div>
